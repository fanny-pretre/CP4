import Engagemen from "../assets/images/engagement.jpg";

function Engagement() {
  return (
    <div className="engage-page">
      <h1>S'engager ! </h1>
      <img src={Engagemen} alt="terrier" className="home-images" />
      <p>
        Chez Le Terrier, nous valorisons profondément l'engagement de notre
        communauté envers la protection des lapins. Chaque geste compte, que ce
        soit en tant que bénévole, donateur ou défenseur de notre cause.
        Ensemble, nous pouvons faire une réelle différence pour ces animaux
        vulnérables.
      </p>
      <h2>
        {" "}
      ...
      <p className="strong">
        Chaque action contribue à créer un monde où tous les lapins peuvent
        vivre heureux, en sécurité et entourés d'amour. Rejoignez-nous dans
        cette mission ! 🌸
      </p>
    </div>
  );
